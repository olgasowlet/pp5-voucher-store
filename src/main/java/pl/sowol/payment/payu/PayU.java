...
import pl.sowol.payment.payu.http.PayUHttp;
import pl.sowol.payment.payu.model.AccessTokenResponse;
...
public class PayU {
    ...
    public PayU(PayUApiConfiguration configuration, PayUHttp netHttpClientPayuHttp) {
